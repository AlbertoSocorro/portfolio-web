...
from portfolio.models import Estudio, Experiencia, PerfilGlobal, Proyecto, Tecnologia
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        tech_tailwind = Tecnologia.objects.create(
            nombre="Tailwind CSS", slug="tailwind-css", categoria="frontend"
        )
        tech_htmx = Tecnologia.objects.create(nombre="HTMX", slug="htmx", categoria="frontend")
        tech_postgresql = Tecnologia.objects.create(
            nombre="PostgreSQL", slug="postgresql", categoria="db"
        )
